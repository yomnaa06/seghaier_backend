...
class AuthController {
    ...
    static async register(req, res) {
        try {
            ...
            if (clientType === 'INDIVIDUEL') {
                ...
                result = await authService_1.AuthService.registerIndividual({
                ...
                result = await authService_1.AuthService.registerCompany({
    ...
    static async login(req, res) {
        try {
            ...
            const result = await authService_1.AuthService.loginUser({ email, password, clientType });
    ...
    static async getProfile(req, res) {
        try {
            ...
            const profile = await authService_1.AuthService.getClientProfile(userId);
    ...
    static async updateProfile(req, res) {
        try {
            ...
            const updatedClient = await authService_1.AuthService.updateClientProfile(userId, req.body);
            return res.status(200).json({
                success: true,
